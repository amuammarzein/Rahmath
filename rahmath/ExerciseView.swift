...
struct ExerciseView: View {
    ...
    @AppStorage("HERO_IMG") var heroImage: String = "avatar_2"
        ...
        NavigationStack {
            VStack {
                ZStack {
                    ...
                    Image(heroImage)
                        .resizable()
                        .scaledToFit().frame(width: screenWidth / 2).shadow(color: .black, radius: 2, x: 3, y: 3).offset(x: 0, y: movingIcon ? -5 : 0)
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        TextField("Write your name", text: $heroName).padding(.leading, 10)
                            .frame(height: 60)
